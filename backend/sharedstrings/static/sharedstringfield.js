...
var register_autocomplete = function ($) {
    var countries = [];
    var l = document.getElementsByClassName("autocompleteInput");
    for (var i = 0; i < l.length; i++) {
        autocomplete(l[i], countries);
    }
...
//Really really make sure the page is loaded before registering the autocompletes.
